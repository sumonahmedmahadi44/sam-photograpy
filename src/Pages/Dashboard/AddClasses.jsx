    ...
    const onSubmit = data => {
        ...
        .then(imgResponse => {
            if(imgResponse.success){
                ...
                const {className, price, AvailableSeat, } = data;
                const newClass = {className:className, price: parseFloat(price), AvailableSeat:parseFloat(AvailableSeat),  image:imgURL}
    ...
    return (
        <div className="w-full px-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className="btn btn-sm mt-4 bg-teal-200" type="submit" value="Add class" />
            </form>
        </div>
    );
};
